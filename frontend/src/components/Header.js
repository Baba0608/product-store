...
export const Header = () => {
  ...
  const navItems = [
    { id: 1, text: "Home", to: "/user/home" },
    { id: 2, text: "Orders", to: "/user/orders" },
    { id: 3, text: "Cart", to: "/user/cart" },
    { id: 4, text: "Logout", to: "/user/login" },
  ];
  return (
    <div className="flex items-center bg-pink-200 justify-between h-20 fixed w-full top-0 left-0 shadow-lg">
      ...
      {/* for mobile */}
      <div className="text-lg flex justify-center sm:hidden relative">
        <ul
          className={
            nav
